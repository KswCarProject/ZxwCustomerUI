...
public class SettingsItem extends RecycleItemBase {
    ...
    public View getSetView(Context context, boolean z) {
        ...
        if (this.mSmallMode == z && (view = this.mSettingView) != null) {
            return view;
        }
        this.mSmallMode = z;
        if (this.m_iModeSet == 20) {
            if (z) {
                this.mSettingView = LayoutInflater.from(context).inflate(R.layout.pemp_bmw_id8_settings_item_layout_small, (ViewGroup) null);
            } else {
                this.mSettingView = LayoutInflater.from(context).inflate(R.layout.pemp_bmw_id8_settings_item_layout, (ViewGroup) null);
            }
        } else if (z) {
            this.mSettingView = LayoutInflater.from(context).inflate(R.layout.bmw_id8_settings_item_layout_small, (ViewGroup) null);
        } else {
            this.mSettingView = LayoutInflater.from(context).inflate(R.layout.bmw_id8_settings_item_layout, (ViewGroup) null);
        }
        init();
    ...
    private void init() {
        ImageView imageView = (ImageView) this.mSettingView.findViewById(R.id.imgBk);
        this.imgBk = imageView;
        if (imageView != null) {
            imageView.setVisibility(this.mSmallMode ? 8 : 0);
        }
        this.imgLine = this.mSettingView.findViewById(R.id.imgLine);
        this.mTitle = (TextView) this.mSettingView.findViewById(R.id.title);
        updateInfo();
    }

    public void updateInfo() {
        if (this.mTitle != null) {
            this.mTitle.setText(this.mContext.getString(R.string.lb_settings).toUpperCase());
        }
    ...
    public void updataFocusState(boolean z) {
        ...
        if (!z) {
            ...
            if (i == 0) {
                ...
                ImageView imageView5 = this.imgBk;
                if (imageView5 != null) {
                    imageView5.setForeground(this.mSmallMode ? getDrawable(R.drawable.id8_main_edit_icon_weather_r_f) : getDrawable(R.drawable.pemp_id8_main_icon_weather_r_f));
                }
            ...
            if (i2 == 0) {
                ...
                if (imageView7 != null) {
                    imageView7.setForeground(this.mSmallMode ? getDrawable(R.drawable.id8_main_edit_icon_weather_r_f) : getDrawable(R.drawable.id8_main_icon_weather_r_f));
                }
