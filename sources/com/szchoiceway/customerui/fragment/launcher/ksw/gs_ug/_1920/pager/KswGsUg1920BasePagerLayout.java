...
public abstract class KswGsUg1920BasePagerLayout extends ConstraintLayout {
    ...
    public KswGsUg1920BasePagerLayout(Context context) {
        super(context);
        init();
    }

    public KswGsUg1920BasePagerLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public KswGsUg1920BasePagerLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    private void inflateNormalView(View view, int i) {
        ...
        layoutParams.dimensionRatio = "347:413";
