...
public abstract class KswGsUg1920And1280BaseLauncherIconView extends FrameLayout {
    private static final int DEFAULT_LAYOUT_ID = 1879834769;
    ...
    public int getLayoutId() {
        return R.layout.ksw_gs_ug_1920_and_1280_item_launcher;
    }
    ...
    public KswGsUg1920And1280BaseLauncherIconView(Context context) {
        super(context);
        init();
    }

    public KswGsUg1920And1280BaseLauncherIconView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public KswGsUg1920And1280BaseLauncherIconView(Context context, AttributeSet attributeSet, int i) {
