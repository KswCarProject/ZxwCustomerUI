...
public class GyroScopeWithCompassView extends RelativeLayout implements View.OnLongClickListener {
    ...
    private void init() {
        ...
        this.mBaseX = this.mProvider.getRecordFloat("Sys_3D_Data_Re_X", 0.0f);
        this.mBaseY = this.mProvider.getRecordFloat("Sys_3D_Data_Re_Y", 0.0f);
        this.mBaseZ = this.mProvider.getRecordFloat("Sys_3D_Data_Re_Z", 0.0f);
    ...
    private void reset3DData() {
        ...
        if (sysProviderOpt != null) {
            sysProviderOpt.updateRecord("Sys_3D_Data_Re_X", String.valueOf(this.mBaseX));
            this.mProvider.updateRecord("Sys_3D_Data_Re_Y", String.valueOf(this.mBaseY));
            this.mProvider.updateRecord("Sys_3D_Data_Re_Z", String.valueOf(this.mBaseZ));
        }
    }
