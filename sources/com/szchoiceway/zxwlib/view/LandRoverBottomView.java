...
public class LandRoverBottomView extends RelativeLayout implements View.OnTouchListener {
    ...
    private void enterNavi() {
        ...
        if ((!z || !"com.google.android.apps.maps".equals(recordValue)) && EventUtils.getInstallStatus(this.mContext, recordValue)) {
            str = recordValue;
            str2 = recordValue2;
        }
    ...
    private void enter360() {
        if (SysProviderOpt.getInstance(this.mContext).getRecordInteger("KESAIWEI_SYS_CAMERA_SELECTION", 1) == 3) {
            if (Build.VERSION.SDK_INT == 31) {
                EventUtils.startActivityIfNotRuning(this.mContext, "com.fibocom.multicamera", EventUtils.LIDIAN_MODE_CLASS_NAME);
            } else {
                EventUtils.startActivityIfNotRuning(this.mContext, "com.ivicar.avm", EventUtils.XYQ_MODE_CLASS_NAME);
            }
        }
    }
