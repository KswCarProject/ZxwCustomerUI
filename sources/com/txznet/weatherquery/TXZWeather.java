...
public final class TXZWeather {
    ...
    public TXZWeather(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, ArrayList<HourWeather> arrayList, ArrayList<WeekWeather> arrayList2) {
        String str18 = str;
        String str19 = str3;
        String str20 = str4;
        String str21 = str5;
        ...
        ArrayList<WeekWeather> arrayList4 = arrayList2;
        Intrinsics.checkNotNullParameter(str18, "city");
        Intrinsics.checkNotNullParameter(str19, "dateOfWeek");
        Intrinsics.checkNotNullParameter(str20, "phrase");
        Intrinsics.checkNotNullParameter(str21, "phraseID");
        Intrinsics.checkNotNullParameter(str22, "temperUnit");
        Intrinsics.checkNotNullParameter(str23, "temperature");
        Intrinsics.checkNotNullParameter(str24, "minTemperature");
        Intrinsics.checkNotNullParameter(str25, "maxTemperature");
        Intrinsics.checkNotNullParameter(str26, "windSpeed");
        Intrinsics.checkNotNullParameter(str27, "humidity");
        Intrinsics.checkNotNullParameter(str28, "rainingProbability");
        Intrinsics.checkNotNullParameter(arrayList3, "hoursData");
        Intrinsics.checkNotNullParameter(arrayList4, "weekData");
        this.city = str18;
        this.date = str2;
        this.dateOfWeek = str19;
        this.phrase = str20;
        this.phraseID = str21;
        this.temperUnit = str22;
        this.temperature = str23;
        this.minTemperature = str24;
        this.maxTemperature = str25;
        this.sensibleTemperature = str10;
        this.windSpeed = str26;
        this.humidity = str27;
        this.rainingProbability = str28;
        this.snowingProbability = str14;
        this.atmosphericPressure = str15;
        this.visibility = str16;
        this.uvIndex = str17;
        this.hoursData = arrayList3;
        this.weekData = arrayList4;
    }
