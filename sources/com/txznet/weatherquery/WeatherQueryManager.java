...
@Metadata(d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u0000 (2\u00020\u0001:\u0003()*B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u001f\u001a\u00020\u0014H\u0002J\u0012\u0010 \u001a\u00020\u001e2\b\u0010!\u001a\u0004\u0018\u00010\"H\u0002J\u0016\u0010#\u001a\u00020\u001e2\u0006\u0010\u001f\u001a\u00020\u00142\u0006\u0010$\u001a\u00020%J\u0016\u0010&\u001a\u00020\u001e2\u0006\u0010\u001f\u001a\u00020\u00142\u0006\u0010'\u001a\u00020\u0016R\u000e\u0010\u0003\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u00020\bX.¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\u001a\u0010\r\u001a\u00020\u000eX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012R\u000e\u0010\u0013\u001a\u00020\u0014X.¢\u0006\u0002\n\u0000R\u001c\u0010\u0015\u001a\u0004\u0018\u00010\u0016X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0017\u0010\u0018\"\u0004\b\u0019\u0010\u001aR\u000e\u0010\u001b\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000R\u000e\u0010\u001c\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000¨\u0006+"}, d2 = {"Lcom/txznet/weatherquery/WeatherQueryManager;", "", "()V", "CMD_SYNC_WEATHER_DATA", "", "changeReceiver", "Landroid/content/BroadcastReceiver;", "handler", "Landroid/os/Handler;", "getHandler", "()Landroid/os/Handler;", "setHandler", "(Landroid/os/Handler;)V", "initFlag", "", "getInitFlag", "()Z", "setInitFlag", "(Z)V", "mContext", "Landroid/content/Context;", "mUserSettingListener", "Lcom/txznet/weatherquery/WeatherQueryManager$UserSettingListener;", "getMUserSettingListener", "()Lcom/txznet/weatherquery/WeatherQueryManager$UserSettingListener;", "setMUserSettingListener", "(Lcom/txznet/weatherquery/WeatherQueryManager$UserSettingListener;)V", "serviceClsName", "weatherPkgName", "initParam", "", "context", "processResult", "result", "", "sendWeatherRequest", "callback", "Lcom/txznet/weatherquery/WeatherQueryManager$WeatherCallback;", "setUserSettingListener", "listener", "Companion", "UserSettingListener", "WeatherCallback", "WeatherQuery_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public final class WeatherQueryManager {
    ...
    public final void sendWeatherRequest(Context context, WeatherCallback weatherCallback) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(weatherCallback, "callback");
        ...
        Log.d("QueryCommunication", "start Service and bindService");
        context.bindService(intent, new WeatherQueryManager$sendWeatherRequest$1(this), 1);
    }

    /* access modifiers changed from: private */
    public final void processResult(byte[] bArr) {
        ...
        if (bArr != null) {
            ...
            Log.d("QueryCommunication", "processResult: strResult:" + str);
            WeatherResult weatherResult = (WeatherResult) GsonUtil.fromJson(str, WeatherResult.class);
            if (weatherResult.weather == null) {
                Log.d("QueryCommunication", "processResult: finalResult.weather == null, return finalResult.resultCode:" + weatherResult.resultCode);
                Companion.getMCallback().onFailed(weatherResult.resultCode);
                return;
            }
            Log.d("QueryCommunication(4)", "processResult: source string: " + weatherResult.weather);
            TXZWeather tXZWeather = (TXZWeather) GsonUtil.fromJson(weatherResult.weather, TXZWeather.class);
            String[] strArr = weatherResult.details;
            Log.d("QueryCommunication(4)", "processResult: weather:" + tXZWeather);
            if (strArr == null) {
                Log.d("QueryCommunication(4)", "processResult: onSuccess, deliver weather ,without details because of null");
                WeatherCallback mCallback2 = Companion.getMCallback();
                Intrinsics.checkNotNullExpressionValue(tXZWeather, "weather");
                mCallback2.onSuccess(tXZWeather, (Bundle) null);
                return;
            }
            Bundle bundle = new Bundle();
            bundle.putStringArray("details", strArr);
            int length = strArr.length;
            for (int i = 0; i < length; i++) {
                Log.d("QueryCommunication(4)", "processResult: details:" + strArr[i]);
            }
            WeatherCallback mCallback3 = Companion.getMCallback();
            Intrinsics.checkNotNullExpressionValue(tXZWeather, "weather");
            mCallback3.onSuccess(tXZWeather, bundle);
        }
    }
    ...
    public final void setUserSettingListener(Context context, UserSettingListener userSettingListener) {
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(userSettingListener, "listener");
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("com.txznet.weather.notify.change");
