...
public final class WeatherQueryManager$sendWeatherRequest$1 implements ServiceConnection {
    ...
    WeatherQueryManager$sendWeatherRequest$1(WeatherQueryManager weatherQueryManager) {
        this.this$0 = weatherQueryManager;
    }

    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        Log.d("QueryCommunication", "onServiceConnected: into ");
        byte[] sendInvoke = IQueryService.Stub.asInterface(iBinder).sendInvoke((String) null, this.this$0.CMD_SYNC_WEATHER_DATA, (byte[]) null);
        if (sendInvoke != null) {
            WeatherQueryManager weatherQueryManager = this.this$0;
            Log.d("QueryCommunication", "onServiceConnected: result != null 1");
            weatherQueryManager.processResult(sendInvoke);
        }
    }
