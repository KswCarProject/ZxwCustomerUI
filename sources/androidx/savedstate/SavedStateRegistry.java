...
public final class SavedStateRegistry {
        ...
        if (!this.attached) {
            lifecycle.addObserver(new LifecycleEventObserver() {
                public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                    SavedStateRegistry.m1performAttach$lambda4(SavedStateRegistry.this, lifecycleOwner, event);
                }
            });
            this.attached = true;
            return;
    ...
    public static final void m1performAttach$lambda4(SavedStateRegistry savedStateRegistry, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
