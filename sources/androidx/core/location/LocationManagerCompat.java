...
public final class LocationManagerCompat {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:103:0x012d A[SYNTHETIC, Splitter:B:103:0x012d] */
    /* JADX WARNING: Removed duplicated region for block: B:93:0x010e A[Catch:{ ExecutionException -> 0x0104, TimeoutException -> 0x00e9, all -> 0x00e6, all -> 0x012a }] */
    /* JADX WARNING: Removed duplicated region for block: B:99:0x0123 A[Catch:{ ExecutionException -> 0x0104, TimeoutException -> 0x00e9, all -> 0x00e6, all -> 0x012a }] */
    ...
    private static boolean registerGnssStatusCallback(final android.location.LocationManager r9, android.os.Handler r10, java.util.concurrent.Executor r11, androidx.core.location.GnssStatusCompat.Callback r12) {
        ...
        L_0x0062:
            ...
            androidx.collection.SimpleArrayMap<java.lang.Object, java.lang.Object> r0 = sGnssStatusListeners
            monitor-enter(r0)
            java.lang.Object r3 = r0.get(r12)     // Catch:{ all -> 0x014e }
            androidx.core.location.LocationManagerCompat$GpsStatusTransport r3 = (androidx.core.location.LocationManagerCompat.GpsStatusTransport) r3     // Catch:{ all -> 0x014e }
            if (r3 != 0) goto L_0x0076
            androidx.core.location.LocationManagerCompat$GpsStatusTransport r3 = new androidx.core.location.LocationManagerCompat$GpsStatusTransport     // Catch:{ all -> 0x014e }
            r3.<init>(r9, r12)     // Catch:{ all -> 0x014e }
            goto L_0x0079
        L_0x0076:
            r3.unregister()     // Catch:{ all -> 0x014e }
        L_0x0079:
            r3.register(r11)     // Catch:{ all -> 0x014e }
            java.util.concurrent.FutureTask r11 = new java.util.concurrent.FutureTask     // Catch:{ all -> 0x014e }
            androidx.core.location.LocationManagerCompat$1 r4 = new androidx.core.location.LocationManagerCompat$1     // Catch:{ all -> 0x014e }
            r4.<init>(r9, r3)     // Catch:{ all -> 0x014e }
            r11.<init>(r4)     // Catch:{ all -> 0x014e }
            android.os.Looper r9 = android.os.Looper.myLooper()     // Catch:{ all -> 0x014e }
            android.os.Looper r4 = r10.getLooper()     // Catch:{ all -> 0x014e }
            if (r9 != r4) goto L_0x0094
            r11.run()     // Catch:{ all -> 0x014e }
            goto L_0x009a
        L_0x0094:
            boolean r9 = r10.post(r11)     // Catch:{ all -> 0x014e }
            if (r9 == 0) goto L_0x0135
        L_0x009a:
            java.util.concurrent.TimeUnit r9 = java.util.concurrent.TimeUnit.SECONDS     // Catch:{ ExecutionException -> 0x0104, TimeoutException -> 0x00e9, all -> 0x00e6 }
            r4 = 4
            long r4 = r9.toNanos(r4)     // Catch:{ ExecutionException -> 0x0104, TimeoutException -> 0x00e9, all -> 0x00e6 }
            long r6 = java.lang.System.nanoTime()     // Catch:{ ExecutionException -> 0x0104, TimeoutException -> 0x00e9, all -> 0x00e6 }
            long r6 = r6 + r4
            r9 = r2
        L_0x00a8:
            ...
            java.lang.Thread r9 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x014e }
            r9.interrupt()     // Catch:{ all -> 0x014e }
        L_0x00c4:
        ...
        L_0x00e9:
            ...
            r1 = r2
        L_0x00eb:
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x012a }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ all -> 0x012a }
            r12.<init>()     // Catch:{ all -> 0x012a }
            java.lang.StringBuilder r10 = r12.append(r10)     // Catch:{ all -> 0x012a }
            ...
            java.lang.StringBuilder r10 = r10.append(r12)     // Catch:{ all -> 0x012a }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x012a }
            r9.<init>(r10, r11)     // Catch:{ all -> 0x012a }
            throw r9     // Catch:{ all -> 0x012a }
        L_0x0104:
            r10 = move-exception
            r1 = r2
        L_0x0106:
            java.lang.Throwable r9 = r10.getCause()     // Catch:{ all -> 0x012a }
            boolean r9 = r9 instanceof java.lang.RuntimeException     // Catch:{ all -> 0x012a }
            if (r9 != 0) goto L_0x0123
            java.lang.Throwable r9 = r10.getCause()     // Catch:{ all -> 0x012a }
            boolean r9 = r9 instanceof java.lang.Error     // Catch:{ all -> 0x012a }
            if (r9 == 0) goto L_0x011d
            java.lang.Throwable r9 = r10.getCause()     // Catch:{ all -> 0x012a }
            java.lang.Error r9 = (java.lang.Error) r9     // Catch:{ all -> 0x012a }
            throw r9     // Catch:{ all -> 0x012a }
        L_0x011d:
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x012a }
        ...
        L_0x0123:
            java.lang.Throwable r9 = r10.getCause()     // Catch:{ all -> 0x012a }
            java.lang.RuntimeException r9 = (java.lang.RuntimeException) r9     // Catch:{ all -> 0x012a }
            throw r9     // Catch:{ all -> 0x012a }
        L_0x012a:
            r10 = move-exception
        L_0x012b:
        ...
        L_0x0135:
            ...
            java.lang.StringBuilder r10 = r11.append(r10)     // Catch:{ all -> 0x014e }
            java.lang.String r11 = " is shutting down"
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x014e }
