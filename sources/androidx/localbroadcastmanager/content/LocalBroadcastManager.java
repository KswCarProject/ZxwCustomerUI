...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r22) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0185 }
            android.content.Context r3 = r0.mAppContext     // Catch:{ all -> 0x0185 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x0185 }
            java.lang.String r11 = r1.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x0185 }
            android.net.Uri r12 = r22.getData()     // Catch:{ all -> 0x0185 }
            java.lang.String r13 = r22.getScheme()     // Catch:{ all -> 0x0185 }
            java.util.Set r14 = r22.getCategories()     // Catch:{ all -> 0x0185 }
            int r3 = r22.getFlags()     // Catch:{ all -> 0x0185 }
            r3 = r3 & 8
        ...
        L_0x002e:
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r4 = r4.append(r11)     // Catch:{ all -> 0x0185 }
            java.lang.String r5 = " scheme "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r4 = r4.append(r13)     // Catch:{ all -> 0x0185 }
            java.lang.String r5 = " of intent "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r4 = r4.append(r1)     // Catch:{ all -> 0x0185 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0185 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0185 }
        L_0x005c:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r0.mActions     // Catch:{ all -> 0x0185 }
            java.lang.String r4 = r22.getAction()     // Catch:{ all -> 0x0185 }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x0185 }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x0185 }
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r4 = r4.append(r8)     // Catch:{ all -> 0x0185 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0185 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0185 }
        L_0x0085:
            r3 = 0
            ...
            r6 = 0
        L_0x0088:
            int r3 = r8.size()     // Catch:{ all -> 0x0185 }
            if (r6 >= r3) goto L_0x0152
            java.lang.Object r3 = r8.get(r6)     // Catch:{ all -> 0x0185 }
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x0185 }
            if (r16 == 0) goto L_0x00b1
            java.lang.String r3 = "LocalBroadcastManager"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0185 }
            r4.<init>()     // Catch:{ all -> 0x0185 }
            java.lang.String r9 = "Matching against filter "
            java.lang.StringBuilder r4 = r4.append(r9)     // Catch:{ all -> 0x0185 }
            android.content.IntentFilter r9 = r5.filter     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r4 = r4.append(r9)     // Catch:{ all -> 0x0185 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0185 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0185 }
        L_0x00b1:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x0185 }
        ...
        L_0x00be:
            ...
            goto L_0x0147
        L_0x00ca:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x0185 }
            ...
            r20 = r11
            r11 = 1
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0185 }
            ...
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x0185 }
            java.lang.StringBuilder r3 = r5.append(r3)     // Catch:{ all -> 0x0185 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0185 }
            android.util.Log.v(r4, r3)     // Catch:{ all -> 0x0185 }
        L_0x0102:
            if (r10 != 0) goto L_0x010a
            java.util.ArrayList r7 = new java.util.ArrayList     // Catch:{ all -> 0x0185 }
            r7.<init>()     // Catch:{ all -> 0x0185 }
            goto L_0x010b
        L_0x010a:
            r7 = r10
        L_0x010b:
            r7.add(r15)     // Catch:{ all -> 0x0185 }
            r15.broadcasting = r11     // Catch:{ all -> 0x0185 }
            goto L_0x0148
        L_0x0111:
        ...
        L_0x0152:
            ...
            r3 = 0
        L_0x0157:
            int r4 = r10.size()     // Catch:{ all -> 0x0185 }
            if (r3 >= r4) goto L_0x0169
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x0185 }
            ...
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x0185 }
            int r3 = r3 + 1
            goto L_0x0157
        L_0x0169:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r0.mPendingBroadcasts     // Catch:{ all -> 0x0185 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0185 }
            r4.<init>(r1, r10)     // Catch:{ all -> 0x0185 }
            r3.add(r4)     // Catch:{ all -> 0x0185 }
            android.os.Handler r1 = r0.mHandler     // Catch:{ all -> 0x0185 }
            boolean r1 = r1.hasMessages(r11)     // Catch:{ all -> 0x0185 }
            if (r1 != 0) goto L_0x0180
            android.os.Handler r0 = r0.mHandler     // Catch:{ all -> 0x0185 }
            r0.sendEmptyMessage(r11)     // Catch:{ all -> 0x0185 }
        L_0x0180:
