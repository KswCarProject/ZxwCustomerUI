...
public final class SavedStateHandle {
    ...
    public static final Bundle m0savedStateProvider$lambda0(SavedStateHandle savedStateHandle) {
    ...
    public SavedStateHandle(Map<String, ? extends Object> map) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() {
            public final Bundle saveState() {
                return SavedStateHandle.m0savedStateProvider$lambda0(SavedStateHandle.this);
            }
        };
