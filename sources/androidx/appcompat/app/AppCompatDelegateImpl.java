...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x007d, code lost:
        if (((org.xmlpull.v1.XmlPullParser) r15).getDepth() > 1) goto L_0x0087;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (!(configuration2 == null || configuration.diff(configuration2) == 0)) {
            ...
            if ((configuration.screenLayout & GyroScopeWithCompassView.CARTYPE_TUCSON_HI) != (configuration2.screenLayout & GyroScopeWithCompassView.CARTYPE_TUCSON_HI)) {
                configuration3.screenLayout |= configuration2.screenLayout & GyroScopeWithCompassView.CARTYPE_TUCSON_HI;
            }
