...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0033:
                ...
                okhttp3.internal.cache.DiskLruCache r5 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                okio.Sink r1 = okio.Okio.blackhole()     // Catch:{ all -> 0x0045 }
                okio.BufferedSink r1 = okio.Okio.buffer((okio.Sink) r1)     // Catch:{ all -> 0x0045 }
                r5.journalWriter = r1     // Catch:{ all -> 0x0045 }
            L_0x0043:
                monitor-exit(r0)     // Catch:{ all -> 0x0045 }
                return
            L_0x0045:
    ...
    private void readJournal() throws java.io.IOException {
        /*
            r8 = this;
            java.lang.String r0 = ", "
            okhttp3.internal.io.FileSystem r1 = r8.fileSystem
            ...
            boolean r7 = r7.equals(r2)     // Catch:{ all -> 0x00b2 }
            if (r7 == 0) goto L_0x007a
            java.lang.String r7 = "1"
            boolean r7 = r7.equals(r3)     // Catch:{ all -> 0x00b2 }
            if (r7 == 0) goto L_0x007a
            int r7 = r8.appVersion     // Catch:{ all -> 0x00b2 }
            java.lang.String r7 = java.lang.Integer.toString(r7)     // Catch:{ all -> 0x00b2 }
            boolean r4 = r7.equals(r4)     // Catch:{ all -> 0x00b2 }
            if (r4 == 0) goto L_0x007a
            int r4 = r8.valueCount     // Catch:{ all -> 0x00b2 }
            java.lang.String r4 = java.lang.Integer.toString(r4)     // Catch:{ all -> 0x00b2 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x00b2 }
            if (r4 == 0) goto L_0x007a
            java.lang.String r4 = ""
            boolean r4 = r4.equals(r6)     // Catch:{ all -> 0x00b2 }
            if (r4 == 0) goto L_0x007a
            r0 = 0
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r2 = r8.lruEntries     // Catch:{ all -> 0x00b2 }
            int r2 = r2.size()     // Catch:{ all -> 0x00b2 }
            int r0 = r0 - r2
            r8.redundantOpCount = r0     // Catch:{ all -> 0x00b2 }
            boolean r0 = r1.exhausted()     // Catch:{ all -> 0x00b2 }
            if (r0 != 0) goto L_0x0070
            r8.rebuildJournal()     // Catch:{ all -> 0x00b2 }
            goto L_0x0076
        L_0x0070:
            okio.BufferedSink r0 = r8.newJournalWriter()     // Catch:{ all -> 0x00b2 }
            r8.journalWriter = r0     // Catch:{ all -> 0x00b2 }
        L_0x0076:
        ...
        L_0x007a:
            ...
            java.lang.StringBuilder r4 = r4.append(r7)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r2 = r4.append(r2)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r2 = r2.append(r0)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r2 = r2.append(r0)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r2 = r2.append(r5)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ all -> 0x00b2 }
            java.lang.StringBuilder r0 = r0.append(r6)     // Catch:{ all -> 0x00b2 }
            java.lang.String r2 = "]"
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x00b2 }
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        /*
            r9 = this;
            monitor-enter(r9)
            okhttp3.internal.cache.DiskLruCache$Entry r0 = r10.entry     // Catch:{ all -> 0x00fd }
            ...
            r2 = r1
        L_0x000f:
            int r3 = r9.valueCount     // Catch:{ all -> 0x00fd }
            if (r2 >= r3) goto L_0x0049
            boolean[] r3 = r10.written     // Catch:{ all -> 0x00fd }
            boolean r3 = r3[r2]     // Catch:{ all -> 0x00fd }
            if (r3 == 0) goto L_0x002d
            okhttp3.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x00fd }
            java.io.File[] r4 = r0.dirtyFiles     // Catch:{ all -> 0x00fd }
            r4 = r4[r2]     // Catch:{ all -> 0x00fd }
            boolean r3 = r3.exists(r4)     // Catch:{ all -> 0x00fd }
            if (r3 != 0) goto L_0x002a
            r10.abort()     // Catch:{ all -> 0x00fd }
            monitor-exit(r9)
            return
        L_0x002a:
            int r2 = r2 + 1
        ...
        L_0x002d:
            ...
            java.lang.StringBuilder r11 = r11.append(r0)     // Catch:{ all -> 0x00fd }
            java.lang.StringBuilder r11 = r11.append(r2)     // Catch:{ all -> 0x00fd }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x00fd }
            r10.<init>(r11)     // Catch:{ all -> 0x00fd }
            throw r10     // Catch:{ all -> 0x00fd }
        L_0x0049:
            int r10 = r9.valueCount     // Catch:{ all -> 0x00fd }
            if (r1 >= r10) goto L_0x0081
            java.io.File[] r10 = r0.dirtyFiles     // Catch:{ all -> 0x00fd }
            r10 = r10[r1]     // Catch:{ all -> 0x00fd }
            if (r11 == 0) goto L_0x0079
            okhttp3.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x00fd }
            boolean r2 = r2.exists(r10)     // Catch:{ all -> 0x00fd }
            if (r2 == 0) goto L_0x007e
            java.io.File[] r2 = r0.cleanFiles     // Catch:{ all -> 0x00fd }
            r2 = r2[r1]     // Catch:{ all -> 0x00fd }
            okhttp3.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x00fd }
            r3.rename(r10, r2)     // Catch:{ all -> 0x00fd }
            long[] r10 = r0.lengths     // Catch:{ all -> 0x00fd }
            r3 = r10[r1]     // Catch:{ all -> 0x00fd }
            okhttp3.internal.io.FileSystem r10 = r9.fileSystem     // Catch:{ all -> 0x00fd }
            long r5 = r10.size(r2)     // Catch:{ all -> 0x00fd }
            long[] r10 = r0.lengths     // Catch:{ all -> 0x00fd }
            r10[r1] = r5     // Catch:{ all -> 0x00fd }
            long r7 = r9.size     // Catch:{ all -> 0x00fd }
            long r7 = r7 - r3
            long r7 = r7 + r5
            r9.size = r7     // Catch:{ all -> 0x00fd }
            goto L_0x007e
        L_0x0079:
            okhttp3.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x00fd }
            r2.delete(r10)     // Catch:{ all -> 0x00fd }
        L_0x007e:
            int r1 = r1 + 1
            goto L_0x0049
        L_0x0081:
            int r10 = r9.redundantOpCount     // Catch:{ all -> 0x00fd }
            r1 = 1
            int r10 = r10 + r1
            r9.redundantOpCount = r10     // Catch:{ all -> 0x00fd }
            r10 = 0
            r0.currentEditor = r10     // Catch:{ all -> 0x00fd }
            boolean r10 = r0.readable     // Catch:{ all -> 0x00fd }
            r10 = r10 | r11
            r2 = 10
            r3 = 32
            if (r10 == 0) goto L_0x00bd
            r0.readable = r1     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            java.lang.String r1 = "CLEAN"
            okio.BufferedSink r10 = r10.writeUtf8(r1)     // Catch:{ all -> 0x00fd }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x00fd }
            r10.writeUtf8(r1)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            r0.writeLengths(r10)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            r10.writeByte(r2)     // Catch:{ all -> 0x00fd }
            if (r11 == 0) goto L_0x00db
            long r10 = r9.nextSequenceNumber     // Catch:{ all -> 0x00fd }
            r1 = 1
            long r1 = r1 + r10
            r9.nextSequenceNumber = r1     // Catch:{ all -> 0x00fd }
            r0.sequenceNumber = r10     // Catch:{ all -> 0x00fd }
            goto L_0x00db
        L_0x00bd:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r10 = r9.lruEntries     // Catch:{ all -> 0x00fd }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fd }
            r10.remove(r11)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            java.lang.String r11 = "REMOVE"
            okio.BufferedSink r10 = r10.writeUtf8(r11)     // Catch:{ all -> 0x00fd }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fd }
            r10.writeUtf8(r11)     // Catch:{ all -> 0x00fd }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            r10.writeByte(r2)     // Catch:{ all -> 0x00fd }
        L_0x00db:
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fd }
            r10.flush()     // Catch:{ all -> 0x00fd }
            long r10 = r9.size     // Catch:{ all -> 0x00fd }
            long r0 = r9.maxSize     // Catch:{ all -> 0x00fd }
            int r10 = (r10 > r0 ? 1 : (r10 == r0 ? 0 : -1))
            if (r10 > 0) goto L_0x00ee
            boolean r10 = r9.journalRebuildRequired()     // Catch:{ all -> 0x00fd }
            if (r10 == 0) goto L_0x00f5
        L_0x00ee:
            java.util.concurrent.Executor r10 = r9.executor     // Catch:{ all -> 0x00fd }
            java.lang.Runnable r11 = r9.cleanupRunnable     // Catch:{ all -> 0x00fd }
    ...
    public final class Editor {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public okio.Source newSource(int r4) {
            /*
                r3 = this;
                okhttp3.internal.cache.DiskLruCache r0 = okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
                boolean r1 = r3.done     // Catch:{ all -> 0x002f }
                if (r1 != 0) goto L_0x0029
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.entry     // Catch:{ all -> 0x002f }
            ...
            L_0x0015:
                ...
                okhttp3.internal.cache.DiskLruCache$Entry r3 = r3.entry     // Catch:{ FileNotFoundException -> 0x0025 }
                java.io.File[] r3 = r3.cleanFiles     // Catch:{ FileNotFoundException -> 0x0025 }
                r3 = r3[r4]     // Catch:{ FileNotFoundException -> 0x0025 }
                okio.Source r3 = r1.source(r3)     // Catch:{ FileNotFoundException -> 0x0025 }
