    ...
    class RelaySource implements Source {
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            ...
            L_0x000b:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0136 }
            ...
            L_0x0020:
                ...
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0136 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0136 }
            ...
            L_0x0039:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0136 }
                okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0136 }
            ...
            L_0x0109:
                ...
                okhttp3.internal.cache2.Relay r1 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0118 }
                r1.notifyAll()     // Catch:{ all -> 0x0118 }
            ...
            L_0x011b:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0136 }
                okio.Buffer r13 = r0.buffer     // Catch:{ all -> 0x0136 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0136 }
                long r15 = r5 - r11
                r14 = r22
                r17 = r2
                r13.copyTo((okio.Buffer) r14, (long) r15, (long) r17)     // Catch:{ all -> 0x0136 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0136 }
                long r5 = r5 + r2
