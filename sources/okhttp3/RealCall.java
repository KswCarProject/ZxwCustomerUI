...
final class RealCall implements Call {
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:14:0x0055 A[Catch:{ all -> 0x002b }] */
        ...
        public void execute() {
            /*
                ...
                okhttp3.Callback r1 = r6.responseCallback     // Catch:{ IOException -> 0x0029 }
            ...
            L_0x0031:
                ...
                java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x002b }
                ...
                goto L_0x005c
            L_0x0055:
                okhttp3.Callback r0 = r6.responseCallback     // Catch:{ all -> 0x002b }
    ...
    public Response getResponseWithInterceptorChain() throws IOException {
        ...
        return new RealInterceptorChain(arrayList, (StreamAllocation) null, (HttpCodec) null, (RealConnection) null, 0, this.originalRequest).proceed(this.originalRequest);
    }
}
