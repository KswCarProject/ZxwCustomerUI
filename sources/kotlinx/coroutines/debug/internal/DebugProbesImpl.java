...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m14constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
    ...
    public final void install() {
        ...
        L_0x003b:
            ...
            kotlinx.coroutines.debug.internal.AgentInstallationType r3 = kotlinx.coroutines.debug.internal.AgentInstallationType.INSTANCE     // Catch:{ all -> 0x006c }
            boolean r3 = r3.isInstalledStatically$kotlinx_coroutines_core()     // Catch:{ all -> 0x006c }
        ...
        L_0x0052:
            ...
            goto L_0x005e
        L_0x0057:
            java.lang.Boolean r4 = java.lang.Boolean.valueOf(r5)     // Catch:{ all -> 0x006c }
    ...
    public final void uninstall() {
        ...
        L_0x001c:
            ...
            r5.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r3 = INSTANCE     // Catch:{ all -> 0x0088 }
            boolean r4 = r3.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0088 }
            if (r4 == 0) goto L_0x007c
            int r4 = installations     // Catch:{ all -> 0x0088 }
            int r4 = r4 + -1
            installations = r4     // Catch:{ all -> 0x0088 }
            int r4 = installations     // Catch:{ all -> 0x0088 }
        ...
        L_0x003d:
            ...
            return
        L_0x0041:
            r3.stopWeakRefCleanerThread()     // Catch:{ all -> 0x0088 }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner<?>, java.lang.Boolean> r3 = capturedCoroutinesMap     // Catch:{ all -> 0x0088 }
            r3.clear()     // Catch:{ all -> 0x0088 }
            kotlinx.coroutines.debug.internal.ConcurrentWeakMap<kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl> r3 = callerInfoCache     // Catch:{ all -> 0x0088 }
            r3.clear()     // Catch:{ all -> 0x0088 }
            kotlinx.coroutines.debug.internal.AgentInstallationType r3 = kotlinx.coroutines.debug.internal.AgentInstallationType.INSTANCE     // Catch:{ all -> 0x0088 }
            boolean r3 = r3.isInstalledStatically$kotlinx_coroutines_core()     // Catch:{ all -> 0x0088 }
        ...
        L_0x005e:
            ...
            return
        L_0x0062:
            kotlin.jvm.functions.Function1<java.lang.Boolean, kotlin.Unit> r3 = dynamicAttach     // Catch:{ all -> 0x0088 }
            if (r3 != 0) goto L_0x0067
            goto L_0x006e
        L_0x0067:
            java.lang.Boolean r4 = java.lang.Boolean.valueOf(r2)     // Catch:{ all -> 0x0088 }
            r3.invoke(r4)     // Catch:{ all -> 0x0088 }
        L_0x006e:
            kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0088 }
        L_0x0070:
        ...
        L_0x007c:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0088 }
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r13) {
        ...
        L_0x001c:
            ...
            r12.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r3 = INSTANCE     // Catch:{ all -> 0x00fb }
            boolean r4 = r3.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x00fb }
            if (r4 == 0) goto L_0x00ef
            java.lang.String r4 = "Coroutines dump "
            java.text.SimpleDateFormat r5 = dateFormat     // Catch:{ all -> 0x00fb }
            long r6 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x00fb }
            java.lang.Long r6 = java.lang.Long.valueOf(r6)     // Catch:{ all -> 0x00fb }
            java.lang.String r5 = r5.format(r6)     // Catch:{ all -> 0x00fb }
            java.lang.String r4 = kotlin.jvm.internal.Intrinsics.stringPlus(r4, r5)     // Catch:{ all -> 0x00fb }
            r13.print(r4)     // Catch:{ all -> 0x00fb }
            java.util.Set r3 = r3.getCapturedCoroutines()     // Catch:{ all -> 0x00fb }
            java.lang.Iterable r3 = (java.lang.Iterable) r3     // Catch:{ all -> 0x00fb }
            kotlin.sequences.Sequence r3 = kotlin.collections.CollectionsKt.asSequence(r3)     // Catch:{ all -> 0x00fb }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r4 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x00fb }
            kotlin.jvm.functions.Function1 r4 = (kotlin.jvm.functions.Function1) r4     // Catch:{ all -> 0x00fb }
            kotlin.sequences.Sequence r3 = kotlin.sequences.SequencesKt.filter(r3, r4)     // Catch:{ all -> 0x00fb }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1 r4 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1     // Catch:{ all -> 0x00fb }
            r4.<init>()     // Catch:{ all -> 0x00fb }
            java.util.Comparator r4 = (java.util.Comparator) r4     // Catch:{ all -> 0x00fb }
            kotlin.sequences.Sequence r3 = kotlin.sequences.SequencesKt.sortedWith(r3, r4)     // Catch:{ all -> 0x00fb }
            java.util.Iterator r3 = r3.iterator()     // Catch:{ all -> 0x00fb }
        L_0x0063:
            boolean r4 = r3.hasNext()     // Catch:{ all -> 0x00fb }
            if (r4 == 0) goto L_0x00e1
            java.lang.Object r4 = r3.next()     // Catch:{ all -> 0x00fb }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r4 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r4     // Catch:{ all -> 0x00fb }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r5 = r4.info     // Catch:{ all -> 0x00fb }
            java.util.List r6 = r5.lastObservedStackTrace()     // Catch:{ all -> 0x00fb }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r7 = INSTANCE     // Catch:{ all -> 0x00fb }
            java.lang.String r8 = r5.getState()     // Catch:{ all -> 0x00fb }
            java.lang.Thread r9 = r5.lastObservedThread     // Catch:{ all -> 0x00fb }
            java.util.List r8 = r7.enhanceStackTraceWithThreadDumpImpl(r8, r9, r6)     // Catch:{ all -> 0x00fb }
            java.lang.String r9 = r5.getState()     // Catch:{ all -> 0x00fb }
            java.lang.String r10 = "RUNNING"
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r10)     // Catch:{ all -> 0x00fb }
            if (r9 == 0) goto L_0x009a
            if (r8 != r6) goto L_0x009a
            java.lang.String r9 = r5.getState()     // Catch:{ all -> 0x00fb }
            java.lang.String r10 = " (Last suspension stacktrace, not an actual stacktrace)"
            java.lang.String r9 = kotlin.jvm.internal.Intrinsics.stringPlus(r9, r10)     // Catch:{ all -> 0x00fb }
            goto L_0x009e
        L_0x009a:
            java.lang.String r9 = r5.getState()     // Catch:{ all -> 0x00fb }
        L_0x009e:
            ...
            kotlin.coroutines.Continuation<T> r4 = r4.delegate     // Catch:{ all -> 0x00fb }
            java.lang.StringBuilder r4 = r10.append(r4)     // Catch:{ all -> 0x00fb }
            java.lang.String r10 = ", state: "
            java.lang.StringBuilder r4 = r4.append(r10)     // Catch:{ all -> 0x00fb }
            java.lang.StringBuilder r4 = r4.append(r9)     // Catch:{ all -> 0x00fb }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x00fb }
            r13.print(r4)     // Catch:{ all -> 0x00fb }
            boolean r4 = r6.isEmpty()     // Catch:{ all -> 0x00fb }
            if (r4 == 0) goto L_0x00dd
            java.lang.String r4 = "\n\tat "
            java.lang.String r6 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r6 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r6)     // Catch:{ all -> 0x00fb }
            java.lang.String r4 = kotlin.jvm.internal.Intrinsics.stringPlus(r4, r6)     // Catch:{ all -> 0x00fb }
            r13.print(r4)     // Catch:{ all -> 0x00fb }
            java.util.List r4 = r5.getCreationStackTrace()     // Catch:{ all -> 0x00fb }
            r7.printStackTrace(r13, r4)     // Catch:{ all -> 0x00fb }
            goto L_0x0063
        L_0x00dd:
            r7.printStackTrace(r13, r8)     // Catch:{ all -> 0x00fb }
            goto L_0x0063
        L_0x00e1:
            kotlin.Unit r13 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00fb }
        L_0x00e3:
        ...
        L_0x00ef:
            ...
            java.lang.IllegalStateException r3 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00fb }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x00fb }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m14constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m14constructorimpl(ResultKt.createFailure(th));
        }
