...
public final class DelayKt {
    ...
    public static final Object m1438delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1439toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1439toDelayMillisLRDsOJo(long j) {
        if (Duration.m1299compareToLRDsOJo(j, Duration.Companion.m1402getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1318getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
