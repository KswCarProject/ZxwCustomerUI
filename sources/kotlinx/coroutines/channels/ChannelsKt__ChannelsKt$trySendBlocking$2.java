    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m14constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m14constructorimpl(Unit.INSTANCE);
        if (Result.m21isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1474successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1472closedJP2dKIU(Result.m17exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1459boximpl(obj3);
    }
}
