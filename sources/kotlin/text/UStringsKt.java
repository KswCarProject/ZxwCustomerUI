...
public final class UStringsKt {
    ...
    public static final String m1286toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1288toStringolVBNx4(short s, int i) {
    ...
    public static final String m1287toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1285toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m81unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m341unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m159unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m237unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m159unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m108constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m26boximpl(UByte.m32constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m159unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m108constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m286boximpl(UShort.m292constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m108constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m361uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m108constructorimpl(i2 * r5);
            int r8 = UInt.m108constructorimpl(UInt.m108constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m186constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m363ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m186constructorimpl(j2 * r9);
            long r4 = ULong.m186constructorimpl(ULong.m186constructorimpl(((long) UInt.m108constructorimpl(digitOf)) & 4294967295L) + r11);
