...
public final class UByteArrayKt {
    ...
    private static final byte[] m100ubyteArrayOfGBYM_sE(byte... bArr) {
    ...
    private static final byte[] UByteArray(int i, Function1<? super Integer, UByte> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bArr[i2] = function1.invoke(Integer.valueOf(i2)).m81unboximpl();
        }
        return UByteArray.m84constructorimpl(bArr);
    }
}
