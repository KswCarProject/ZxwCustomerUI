...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long m1291elapsedNowUwyO8pc() {
        ...
        public TimeMark m1292plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1336plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1402getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
