...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1294getAdjustmentUwyO8pc() {
    ...
    public long m1293elapsedNowUwyO8pc() {
        return Duration.m1335minusLRDsOJo(this.mark.m1429elapsedNowUwyO8pc(), m1294getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1295plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1336plusLRDsOJo(m1294getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
