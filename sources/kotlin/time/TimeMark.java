...
public abstract class TimeMark {
    ...
    public abstract long m1429elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1431plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1430minusLRDsOJo(long j) {
        return m1431plusLRDsOJo(Duration.m1352unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1333isNegativeimpl(m1429elapsedNowUwyO8pc());
    }
