...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1201getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m13boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m1201getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m23unboximpl());
                }
            }
        }
    }
